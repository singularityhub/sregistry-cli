...
We have provided you with a [docker-compose](https://github.com/singularityhub/sregistry-cli/tree/add/aws-push/examples/docker) file so that you can easily deploy your own s3 bucket (via Minio) with 
