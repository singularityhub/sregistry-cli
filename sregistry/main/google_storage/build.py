...
from sregistry.utils import get_recipe_tag, read_json, parse_image_name, remove_uri
...
def get_instances(self, project=None, zone="us-west1-a"):
    ...
    return self._compute_service.instances().list(project=project, zone=zone).execute()
